...
if strcmp(mymeas, 'c')
    ...
    params_upper = [1.5 2.3 0.5 2 0.2 12]; % previous T2 upper limit was 4.7, Beta 1.2
    params_lower = [0.05 2E-10 0.0001 0  T1 0.5]; % previous T2 lower limit was 3.4, Beta .4
    params_guess = [1.004920234	1.81832878	0.001674428	0.276392264 0	5.333203662];
